...
CTextBox::CTextBox(sf::Vector2f position, size_t charSize, sf::String text, std::string ID, bool hide, sf::Color color) : CGuiElement(CGuiElement::GUI_TEXTBOX, position, ID, hide, color)
{
    m_position = position;
    m_charSize = charSize;
