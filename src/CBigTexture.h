...
#ifndef CBIGTEXTURE_H
#define CBIGTEXTURE_H
...
#include <Thor/Aurora/Tools/Swap.hpp>
...
private:
	...
	sf::Vector2f fillSprites(const sf::Color& color, std::vector<class CSprite>& out) const;
